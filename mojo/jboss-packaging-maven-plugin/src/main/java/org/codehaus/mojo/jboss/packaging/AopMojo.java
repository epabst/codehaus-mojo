    ...
    extends AbstractPackagingMojo
{
     ...
     * The artifact type.
     */
    private static final String ARTIFACT_TYPE = "jboss-aop";

    /**
     * The location of the JBoss AOP descriptor file (jboss-aop.xml). If it is present in src/main/resources/META-INF
