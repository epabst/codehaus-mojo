    ...
    implements FactoryBeanField
{
    ...
    public CompositeField( String parentName, String name, Class impl )
    {
        super( parentName, name, BeanField.TYPE_COMPOSITE, true );
    ...
    {
        return new ObjectWrapper( parent, objectToWrap, this.getFieldName(), impl );
    }
}
