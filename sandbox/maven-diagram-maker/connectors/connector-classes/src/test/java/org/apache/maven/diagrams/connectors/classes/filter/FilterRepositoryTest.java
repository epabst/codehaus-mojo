...
public class FilterRepositoryTest extends TestCase
{
    ...
    public void testGetStatus1()
    {
        ...
        classNamesFilter.setIncludes( IncludePattern.createList( new String[] { "org\\.apache\\.maven\\.\\*",
            "java\\.lang\\..*" } ) );
        ...
        assertEquals( ClassFilterStatus.EXCLUDED_WITH_KEEP_EDGES,
                      filterRepository.getStatus( "java.lang.reflect.Array" ) );
