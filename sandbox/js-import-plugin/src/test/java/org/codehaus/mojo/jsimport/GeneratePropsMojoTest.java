...
public class GeneratePropsMojoTest
{
        ...
        throws MojoExecutionException, IOException
    {
        ...
        generateHtmlMojo.setHtmlResourceExtensions( "*.html,*.htm" );
    ...
    {
        generateHtmlMojo.doExecute( sourceJsFolder, sourceJsFolder, resourceHtmlFolder, targetFolder, workFolder,
                                    Scope.COMPILE );
        ...
        assertEquals( "js/b.js\"></script>" + "<script type=\"text/javascript\" src=\"js/c.js\"></script>"
